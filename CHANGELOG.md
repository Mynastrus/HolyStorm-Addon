...
- Established `HolyStorm.Libraries.ADDON_ICON` as the canonical Holy Storm icon for the LDB launcher, its LibDBIcon minimap button, the native main-window portrait, and Retail addon metadata.
