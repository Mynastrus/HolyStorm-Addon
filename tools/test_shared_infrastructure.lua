...
assert(sync:find('prefix="HolyStormSync"', 1, true) and sync:find('protocol="HSC1"', 1, true), "legacy Sync prefix and wire protocol stay compatible")
assert(sync:find("HolyStorm.SyncTransport:Send", 1, true) and not sync:find("C_ChatInfo.SendAddonMessage(", 1, true), "Sync outbound traffic uses the central adapter")
