...
function HolyStorm.Tasks:RegisterTaskType()end;function HolyStorm.Tasks:GetTaskType()return nil end;function HolyStorm.Events:Register()end
...
assert(loadfile(root.."Core/CharacterUI.lua"))();assert(loadfile(root.."UI/Components/HolyStormHeaderBar.lua"))();assert(loadfile(root.."UI/CharacterOverview.lua"))()
