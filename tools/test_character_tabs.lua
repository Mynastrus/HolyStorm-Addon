...
assert(loadfile(uiRoot.."UI/Framework/Layout.lua"))();assert(loadfile(uiRoot.."UI/Framework/Components.lua"))();assert(loadfile(uiRoot.."UI/Framework/Table.lua"))();HolyStorm.UI.Components=HolyStorm.UIComponents
...
C:SelectTab("stats");assert(Page.views.stats and Page.views.stats.table and#Page.views.stats.table.rows==10,"stats tab uses the shared declarative table")
