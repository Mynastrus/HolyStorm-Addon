...
local characterLocale=read(live.."Holy_Storm_Characters/UI/Locales/enUS.lua");for _,key in ipairs({"EQUIPMENT_DISPLAY_NAME","MYTHICPLUS_DISPLAY_NAME","RAID_DISPLAY_NAME","DELVES_DISPLAY_NAME"})do assert(characterLocale:find(key,1,true),"Characters storage consumer is missing locale "..key)end
