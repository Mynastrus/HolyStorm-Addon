...
- Feature-Permissions werden noch überwiegend zentral in `PermissionRegistry.lua` registriert; Module können bereits `RegisterPermission` verwenden, tun dies aber noch nicht flächendeckend.
