...
local metadata={id="professions",name="Professions",displayName=L["DISPLAY_NAME"],description=L["DESCRIPTION"],version=addonVersion,moduleType="feature",category="feature",permissions={{id="professions-read",category="Core"}},dependencies={"core","ui"},capabilities={"character.scan.additional"},ui={page="professions",navigation=true},data={block="professions",capability="character.scan.additional"},enabledByDefault=false}
