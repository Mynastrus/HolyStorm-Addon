...
local metadata={
    id="CharacterRuleData",name="CharacterRuleData",internalName="characterRuleData",displayName=L["RULE_DATA_PROVIDER"],description=L["RULE_DATA_PROVIDER_DESC"],version=addonVersion,moduleType="feature",category="required",dependencies={"core"},data={block="demands"},enabledByDefault=true,
    ruleFields={
