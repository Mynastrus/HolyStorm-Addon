...
HolyStorm:RegisterModule(metadata,function(Module)
 ...
 if HolyStorm.Rules then HolyStorm.Rules:RegisterField("raid.progress",{type="number",dependencies={"raid"},get=function(context)local block=HolyStorm.Data.CharacterStore:GetBlock(context.characterUUID,"raid");local progress=block and block.bestProgress;return progress and tonumber(progress.killed)or nil end})end
