...
local L=localeLibrary and localeLibrary.GetLocale and localeLibrary:GetLocale("Holy_Storm")or setmetatable({},{__index=function(_,key)return key end})
local CharacterUI={version=addonVersion,tabs={},tabOrder={},context=nil,contextToken=0,history={},maxHistory=20,pendingRefreshBlocks={}}
