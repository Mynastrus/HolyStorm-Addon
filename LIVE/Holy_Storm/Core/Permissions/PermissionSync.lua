...
function Sync:Initialize()
    ...
    HolyStorm.Tasks:RegisterTaskType("Policy.RecalculateEffectiveMemberships",{name=L["TASK_POLICY_RECALCULATE"],localizedNameKey="TASK_POLICY_RECALCULATE",module="Policy",priority=20,executionMode="UNIQUE",conditions={"PLAYER_READY","GUILD_AVAILABLE","GUILD_ROSTER_READY"},execute=function() return HolyStorm.Policy:Recalculate() end})
