...
function GuildRoster:Refresh()
    ...
    if HolyStorm.TwinkCore then for guid in pairs(membersByGuid)do local identity=HolyStorm.TwinkCore:GetRosterIdentity(guid,guild);if identity and identity.guildMain and identity.guildMain~=guid and membersByGuid[identity.guildMain]then twinkOwners[guid]=identity.guildMain;twinksByOwner[identity.guildMain]=twinksByOwner[identity.guildMain]or{};table.insert(twinksByOwner[identity.guildMain],membersByGuid[guid])end end end
